...
#define FUNK_BUILDER(FUNC_NAME, FUNC_CHECK, VALUE_CHECK) \
...
int s21_is_equal(s21_decimal value_1, s21_decimal value_2) {
    return value_1.fields.negative == value_2.fields.negative? is_equal_96(value_1, value_2) : FALSE;
}

int s21_is_not_equal(s21_decimal value_1, s21_decimal value_2) {
    return value_1.fields.negative == value_2.fields.negative? is_not_equal_96(value_1, value_2) : TRUE;
}
